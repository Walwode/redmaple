 ...
 * Results:
 * 
 * Arduino Nano (-LED, -5VReg, 5V) - delay
 * CLOCK_PRESCALER_1    14.1mAh
 * CLOCK_PRESCALER_2     9.6mAh
 * CLOCK_PRESCALER_4     7.7mAh
 * CLOCK_PRESCALER_8     6.1mAh
 * CLOCK_PRESCALER_16    5.3mAh
 * CLOCK_PRESCALER_32    4.8mAh
 * CLOCK_PRESCALER_64    4.6mAh
 * CLOCK_PRESCALER_128   4.5mAh
 * CLOCK_PRESCALER_265   4.5mAh
 * 
 * Arduino Nano (-LED, -5VReg, AA) - delay
 * CLOCK_PRESCALER_1    4.72mAh
 * CLOCK_PRESCALER_2    2.91mAh
 * CLOCK_PRESCALER_4    1.82mAh
 * CLOCK_PRESCALER_8    1.18mAh
 * CLOCK_PRESCALER_16   0.79mAh
 * CLOCK_PRESCALER_32   0.59mAh
 * CLOCK_PRESCALER_64   0.49mAh
 * CLOCK_PRESCALER_128  0.44mAh
 * CLOCK_PRESCALER_265  0.41mAh
*/
